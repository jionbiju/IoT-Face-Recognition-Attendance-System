...
def recognize_face():
    ...
    try:
        ...
        # attempt prediction
        from facenet_model import load_model_if_exists, predict_with_model
...
# -------- CSV download --------
# CSV download functionality removed - only Excel (College Format) is supported
# @app.route("/download_csv", methods=["GET"])
# def download_csv():
#     """
#     CSV download functionality has been removed.
#     Use Excel (College Format) download instead.
#     """
#     pass
